...
When:
    ...
    Người dùng nhấn vào nút "Thanh toán" từ trang xem giỏ hàng.
    And Người dùng xác nhận thông tin đặt hàng.
    And Người dùng nhấn "Xác nhận đặt hàng".

Then:

    Một bản ghi đơn hàng mới được tạo trong cơ sở dữ liệu với đầy đủ chi tiết các sản phẩm đã chọn.
...
Then:
    ...
    Thông báo hiển thị thông báo trên màn hình giỏ hàng trống.
...
Then:
    ...
    Thông báo hiển thị thông báo trên màn hình hiện vẫn chưa đăng nhập.
...
When:
    ...
    Người dùng nhấn vào nút "Thanh toán".
    And Hệ thống gặp lỗi kết nối hoặc lỗi xử lý đơn hàng.

Then:

    Hiển thị thông báo lỗi hệ thống, đề nghị thử lại sau.
...
Given:
    ...
    Người quản trị đã đăng nhập thành công.
    And Hệ thống có tài khoản người dùng.

When:

    Người quản trị truy cập vào trang "Danh sách tài khoản".

Then:

    Hệ thống hiển thị danh sách tất cả tài khoản đã đăng ký
...
Then:
    ...
    Hệ thống hiển thị thông báo "Chưa có tài khoản nào được đăng ký".
...
Then:
    ...
    Hệ thống hiển thị thông báo "Có lỗi xảy ra, vui lòng thử lại sau".
